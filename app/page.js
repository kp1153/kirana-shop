...
export default function RationPage() {
  return (
    <main style={{ minHeight: "100vh", background: "#fff", fontFamily: "'Baloo 2', sans-serif" }}>
      ...
      {/* Hero */}
      <section style={{ background: "linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%)", padding: "72px 20px 64px", textAlign: "center" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          <div className="hero-badge">🏪 राशन दुकानदारों के लिए बना software</div>
          <h1 style={{ fontSize: "clamp(32px, 6vw, 60px)", fontWeight: "900", color: "#1c1917", lineHeight: 1.15, marginBottom: "20px" }}>
            दुकान का पूरा हिसाब —<br />
            <span style={{ color: "#ea580c" }}>एक जगह, हिंदी में</span>
          </h1>
          <p style={{ fontSize: "18px", color: "#44403c", fontWeight: "600", marginBottom: "36px", lineHeight: 1.7 }}>
            बिलिंग · Stock · उधारी · Purchase · Reports<br />
          ...
          <p style={{ color: "#78716c", fontSize: "14px", fontWeight: "600" }}>
            ✅ कोई card नहीं &nbsp;·&nbsp; ✅ कोई commitment नहीं &nbsp;·&nbsp; ✅ हिंदी में support
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "64px 20px", background: "#fafaf9" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <h2 className="section-title">क्या यही <span className="orange">परेशानी है?</span></h2>
          <p className="section-sub">हर राशन दुकानदार की यही तकलीफ है — हमने solution बना दिया</p>
